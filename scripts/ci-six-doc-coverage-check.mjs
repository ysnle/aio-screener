...
const checks = [
  ...
  { check: 'telegram digest contains all 4 requested channels', pass: atlasIndex.telegramReferenceArtifact === 'public-data/telegram-digest.json' && atlasIndex.telegramReferenceChannels === 4 && telegramReference.channels.length === 4 && telegramReference.sourceCatalog?.length === 4 && telegramReference.collectionStatus === 'failed' },
