...
async function main() {
  let html, core, data, ui, chat, glossary, pages, krData, versionJson, deployment, publicConfig, indexResponse;
  try {
    [indexResponse, core, data, ui, chat, glossary, pages, krData] = await Promise.all([
