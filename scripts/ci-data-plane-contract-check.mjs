...
const smokeEnv = new Proxy({ AIO_QUOTES_KV: kv }, {
...
if (smokeResponse.status !== 200 || smokeBody.ok !== true || smokeBody.revision !== 'fixture:kv-only') fail('KV-only /health smoke failed');
