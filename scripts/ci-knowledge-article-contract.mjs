...
const requiredArticleFields = ['intuition', 'formalModelOrRationale', 'workedExampleOrRationale', 'realEconomyChannel', 'companyChannel', 'financialStatementChannel', 'valuationChannel', 'marketChannel', 'tradingApplication', 'invalidation', 'glossary', 'retrievalChecks', 'claimIds'];
...
assert(articles.length === 159, `article count ${articles.length} !== 159`);
const ids = new Set();
...
assert(learning.nodes.length === 159, `learning node count ${learning.nodes.length} !== 159`);
