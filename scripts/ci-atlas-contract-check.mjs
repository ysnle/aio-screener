...
if (!atlas.includes('ATLAS_CONCEPT_GUIDES') || !atlas.includes('createTaxonomyGuide') || !atlas.includes('FOUNDATION_TRACK_DISPLAY') || !atlas.includes('FOUNDATION_TEACHING_FRAME') || !atlas.includes('atlas-module-visualization') || !atlas.includes('atlas-module-lens') || !atlas.includes('atlas-module-exploration') || !atlas.includes('TELEGRAM_DISCOVERY_BOUNDARY') || !atlas.includes("F0: { title: '문제·학습·시스템의 공통 언어'" ) || !atlas.includes('AI를 이해하는 7단계')) errors.push('user-facing atlas explanations, complete foundation layers, or discovery boundary');
