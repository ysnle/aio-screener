...
check(suppliedBridge.includes('aioSuppliedMaterialRoute') && suppliedBridge.includes('시계열 정렬') && suppliedBridge.includes('자료 감사'), 'route bridge renders audit and time-series alignment without current-value promotion');
