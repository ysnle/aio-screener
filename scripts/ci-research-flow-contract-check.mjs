...
check(suppliedBridge.includes('claim-level 분석 원장') && suppliedBridge.includes('claimId') && suppliedBridge.includes('현재성 경계'), 'knowledge bridge renders the complete claim-level analysis without promoting current values');
