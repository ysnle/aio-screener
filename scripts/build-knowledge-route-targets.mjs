...
writeJson('public-data/knowledge/route-targets.json', { schemaVersion: 'knowledge-route-targets.v1', generatedAt: reviewedAt, status: 'STRUCTURED_REFERENCE_DRAFT', allowedRoutes: ['atlas', 'principles', 'macro', 'fxbond', 'fundamental', 'themes', 'technical', 'market-news', 'screener', 'entity', 'portfolio', 'options'], counts: { articleTargets: articleTargetCount, compatibilityTargets: MARKET_PRINCIPLES_CATALOG.lessons.length }, targets, scenarios });
