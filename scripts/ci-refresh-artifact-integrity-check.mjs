...
const degradedFred = previousMeta.fredFetchOk === true && currentMeta.fredFetchOk !== true;
...
console.log(JSON.stringify({ ok: true, fred: { previous: previousMeta.fredFetchOk ?? null, current: currentMeta.fredFetchOk ?? null, lkg: currentMeta.fredLkgUsed === true }, quotes: { previous: previousMeta.symbolsOk ?? null, current: currentMeta.symbolsOk ?? null } }));
