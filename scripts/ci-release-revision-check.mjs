...
if (!errors.length) {
  ...
  check('public AI config is revision-bound, non-secret, and fresh-browser usable', publicConfig.schemaVersion === 'ai-public-config.v1'
    ...
    && /^https:\/\//.test(publicConfig.ai?.workerUrl || '')
