...
if (holdings.status !== 'REFERENCE_ROWS_CONNECTED' || holdings.managers.length !== 7 || holdings.reconciledManagers !== 7 || holdings.holdingRowsPublished !== 68 || holdings.fullRowsAvailable !== 1248 || holdings.holdings.length !== 68 || holdings.allHoldings?.length !== 1248 || holdings.comparisonRowsPublished !== 68 || holdings.fullComparisonRowsAvailable !== 1375 || holdings.comparisons?.length !== 1375 || holdings.reconciledComparisons !== 7) fail('SEC holdings or prior-period comparison counts drifted');
