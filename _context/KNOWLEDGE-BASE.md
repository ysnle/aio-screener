...
## 2026-07-28~31 Telegram 3채널 시장 문맥 교차검증 (2026-07-31)

> 범위: `@insidertracking`, `@aetherjapanresearch`, `@bornlupin` 공개 채널의 2026-07-28 00:00 KST 이후 메시지. 브라우저 표본 642건과 공개 미러 1,738건을 분리 집계했다. Telegram은 아이디어/속보 계층이며, 수치·결과·일정은 Fed/BEA/BLS/BOJ/기업 IR 1차 소스로 재확인하기 전 현재 판단 근거가 아니다.

### 확인된 공통 축

- **Fed**: 7월 29일 FOMC는 3.50~3.75% 동결, 9대3 표결이며 3명은 25bp 인상을 선호했다. “매파적 동결”은 해석이고, 실제 다음 인상 여부는 확정 사실이 아니다. 다음 정례회의는 9월 15~16일, 7월 의사록은 8월 19일이다.
- **미국 물가/성장**: BEA의 7월 30일 발표에서 6월 PCE YoY 3.7%, core 3.3%, MoM -0.1%/+0.1%, 2분기 실질 GDP 연율 1.5%가 확인됐다. 기존 FRED LKG의 5월 PCE 4.1%/3.4%와 섞으면 안 된다.
- **AI capex/수익화**: Microsoft Azure +43%, Meta 매출 +28%와 2026 capex $130~145B는 AI 인프라 수요를 확인하지만, Meta FCF $0.784B처럼 capex·현금흐름 부담도 동시에 확인한다. `AI 수요 강함`과 `모든 AI 주식의 현금흐름 우호`는 같은 명제가 아니다.
- **메모리/반도체**: 3채널의 최대 빈도 축은 메모리·반도체였지만, 공급부족·가격·포지셔닝 주장은 업계/브로커 견해가 섞여 있다. 가격(P), 출하/가동률(Q), capex/depreciation/capital을 분리해서 실적과 공시로 확인한다.
- **한국 시장**: 7월 29~31일 급락·반등과 사이드카 관련 메시지가 집중됐다. 미국 완료 종가와 한국 장중 지수를 같은 일별 행에 넣지 않고, 장중은 라이브 세션·차트 일별값은 직전 완료 종가로 분리한다.
- **일본/BOJ**: 7월 30~31일 회의/Outlook 일정은 확인됐지만, 7월 31일 오전 수집 시점에는 결과 발표 전이었다. 일정과 결과를 혼동하지 않으며, 결과는 BOJ 공식 발표 후 갱신한다.
- **지정학·유가·중국/무역**: 빈도는 높지만 재전송·단일 출처 속보가 많다. 방향성 내러티브보다 WTI/DXY/금리/신용스프레드의 동시 반응과 공식 발표를 우선한다.

### 향후 확인 일정

- 8월 4일 미국 JOLTS·무역, 8월 7일 미국 고용, 8월 10일 BOJ Summary of Opinions, 8월 12일 CPI, 8월 13일 PPI, 8월 19일 FOMC 의사록, 8월 26일 미국 GDP 2차 추정·7월 PCE, 9월 15~16일 FOMC, 9월 17~18일 BOJ.
- Apple 배당 record date 8월 10일/pay date 8월 13일은 기업 IR에서 확인됐다. Telegram의 부품·메모리 파급 주장은 별도 공급망 증거가 필요하다.
