...
confidence: high
target_version: v49.17
target_file: index.html + js/*.js
target_lines: index.html 28158 + js modules 27200
---
...
| `js/aio-tests.js` | 1,174 | 브라우저 단위 테스트 T1~T172, `AIO.runTests()` / `AIO.getTestResults()` |
