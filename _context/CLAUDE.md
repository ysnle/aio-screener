...
| FABLE-LIVE-AUDIT-2026-07-07.md | KOSPI -8% 폭락일 라이브 실측 감사(C/L/F/U/X 발견 대장) + 구조 개선 Phase L0~L5. L0~L4 전체(P634-P641, v52.24~26) 같은 세션 실행 완료(§6, L0-1은 운영자 조치까지 완료) — **현행 작업 진입점은 §6 이후 L4 잔여/L5** | 로드맵 항목 완료/재감사 시 |
