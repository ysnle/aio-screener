...
| INSTITUTIONAL-DATA-READINESS-HANDOFF-2026-07-12.md | 기관급 공개 기준의 데이터 원천·페이지별 커버리지·누락 데이터·실제 자동 해설 오류·quote 현재성 결함·WP-0~8 실행 원장 | 각 WP 완료, source/license/public gate 변경 시 |
