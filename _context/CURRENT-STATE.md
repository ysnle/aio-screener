...
generated_from_build: 2026-09-19T10:50:00+09:00
auto_refresh: true
...
| `js/aio-data.js` | 16,679 | 1,017,486 |
...
- Ledgers: latest rule R618; latest postmortem P1125; open QA 166 unique IDs (170 rows, 4 explicitly superseded).
