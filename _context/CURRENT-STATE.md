...
generated_from_build: 2026-09-19T11:44:00+09:00
auto_refresh: true
...
| `js/aio-core.js` | 27,998 | 1,686,991 |
| `js/aio-data.js` | 16,677 | 1,017,517 |
| `js/aio-ui.js` | 4,381 | 274,121 |
| `js/aio-chat.js` | 8,160 | 582,960 |
| `js/aio-tests.js` | 9,322 | 714,221 |
...
- Ledgers: latest rule R620; latest postmortem P1127; open QA 168 unique IDs (172 rows, 4 explicitly superseded).
