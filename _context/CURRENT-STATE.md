...
generated_from_build: 2026-09-20T17:21:00+09:00
auto_refresh: true
...
- App shell: 13,300 lines / 984,458 bytes

| Source | Lines | Bytes |
|---|---:|---:|
| `index.html` | 13,300 | 984,458 |
| `js/aio-core.js` | 28,052 | 1,691,203 |
...
- Ledgers: latest rule R627; latest postmortem P1159; open QA 185 unique IDs (189 rows, 4 explicitly superseded).
