...
| `SCREENER-OPEN-SOURCE-BENCHMARK-AND-REBUILD-HANDOFF-2026-08-12.md` | 전문·브라우저·개인 공개 스크리너 20개 비교와 AIO Screener Workbench 목표 구조, 필드별 provenance·개별 refresh·provider capability·레짐·PIT 검증·SCR-OS-00~11 실행 계약. IMPLEMENTED_LOCAL; live/PIT 승격 경계 유지 | 비교군 기능/라이선스, AIO screener 기준선, target contract, SCR-OS 상태 또는 rebuild trigger 변경 시 |
...
| `MARKET-PRINCIPLES-ATLAS-STRUCTURAL-AUDIT-HANDOFF-2026-08-10.md` | v54.7 진행형 SSOT. 기존 KA-00~10 구조 구현을 보존하고, 주식·경제·금융·기술 백과사전 사명, 111/48/60/95/50/19 전수 corpus, 모든 sector/domain/category, Web Research·심층 원고·정량 lab·시장 적용·KA-11~16 최종 인증을 고정 | KA 상태, ontology/schema, graph/source/article, coverage/research dossier, sector/domain depth, market transmission, persona/state/renderer 또는 live 판정 변경 시 |
