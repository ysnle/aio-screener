...
| `MARKET-PRINCIPLES-PAGE-DESIGN-HANDOFF-2026-08-01.md` | 신규 `시장 원리/자본의 지도` 페이지 DESIGN_ONLY SSOT. 기존 전문 페이지와의 canonical content 경계, 돈·신용·금리·채권·달러·주식·자본주의·산업 공통 프레임, 반도체·AI 데이터센터·전력 심화 커리큘럼, UI/UX·콘텐츠 스키마·업데이트 cadence·MP-00~08 구현 패킷 | 사용자 결정, MVP chapter, route/콘텐츠 소유권, lesson schema, 산업 가치사슬 또는 구현 상태 변경 시 |
| `MARKET-PRINCIPLES-KNOWLEDGE-GRAPH-UX-SPEC-2026-08-01.md` | `시장 원리`의 TREE/GRAPH/PATH 3모드 탐색 UX SSOT. root tree, node/edge ontology, 인과·자금·물리 흐름, 1-hop 과밀 방지, 검색/deep link, 모바일 text alternative, KG-00~07 구현 계약을 정의한 DESIGN_ONLY 명세 | ontology, graph/path content, 검색·deep link·모바일·접근성 또는 구현 상태 변경 시 |
| `AI-ERA-FOUNDATIONS-CURRICULUM-2026-08-01.md` | `시장 원리`의 AI 시대 대분류 상세 curriculum SSOT. 물리·수학·컴퓨터과학·반도체 화학·경제학에서 AI 학습/추론, Transformer, World Model, RAG/Agent, GPU/ASIC/HBM, 칩 제조, AIDC·냉각·전력, 공급망·생산성·노동·위험까지 연결한 DESIGN_ONLY 원고/시각화/AI-0~6 계약 | AI 분류·원고 깊이·source, 모델/칩/AIDC lesson, 시각화 또는 구현 상태 변경 시 |
| `AI-ERA-INDUSTRY-ATLAS-RESEARCH-SPEC-2026-08-01.md` | AI 시대 산업 Atlas DESIGN_ONLY SSOT. 빅테크 Cloud·neocloud·AI CAPEX/ROIC·메모리·파운드리·패키징/유리기판·photonics/CPO·AIDC/전력·on-device/physical AI·드론/방산·우주/항공/Artemis와 source packet→evidence ledger→검수→승격 절차 정의 | 산업 inventory·ontology·research source·기업/기술/재무 metric·ATLAS-00~10 상태 변경 시 |
| `AI-ERA-DEEP-TAXONOMY-PLAYER-PRODUCT-SPEC-2026-08-01.md` | AI 산업을 L0~L6으로 재귀 분해하는 DESIGN_ONLY 깊이 SSOT. foundry 3nm/2nm/18A·yield, DUV/EUV/중국 장비, 전공정/후공정, photonics/CPO, open model·중국 전략·open alliance, player/product schema, Telegram 5채널 discovery 계약과 DT1~DT10 gate 정의 | taxonomy 깊이·기업 역할·제품 portfolio·Telegram source/coverage·DEEP/TG-ATLAS packet 변경 시 |
