...
| `SCREENER-OS-00-BASELINE-2026-08-12.md` | SCR-OS-00 현재 기준선 873/847/77.2, producer→contract→consumer dependency ledger, packet 상태와 명시적 non-claims | screener artifact baseline, packet status, validation/live boundary 변경 시 |
