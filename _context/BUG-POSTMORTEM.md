---
verified_by: P1177 QA-SCR-01(스냅샷 정체성에서 live 파생 필드 분리) + P1176 22 PFR01/PFR06(미설정 목표가 보존·타입 분리) 구현, 각각 단언·실브라우저 게이트 PASS; 22 PFR02~PFR06·11 P11-01(durable ack)·다중통화 환산·UI 통화 표시는 미착수
last_verified: 2026-09-22
confidence: medium
latest_version: v56.15
latest_P_number: P1177
next_P_number: P1178
current_total_entries: 569 tracked entries (396 headings + 173 compacted lines, P1~P1142, 결번 존재) — 종전 "781 (P1~P1067)"은 셀 수 없는 historical 합계였다
