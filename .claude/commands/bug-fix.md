...
This command is a thin wrapper. Before executing, read `_context/WORKFLOW-GOVERNANCE.md`, `_context/INDEX.md`, `.claude/skills/_shared/operating-contract.md`, and `.claude/skills/bug-fix/SKILL.md` completely.
