...
This command is a thin wrapper. Read `_context/CURRENT-STATE.md`, `_context/WORKFLOW-GOVERNANCE.md`, `_context/INDEX.md`, `.claude/skills/_shared/operating-contract.md`, and `.claude/skills/data-refresh/SKILL.md` completely.
...
Run `.claude/skills/data-refresh/SKILL.md`.
