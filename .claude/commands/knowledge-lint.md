...
This command is a thin wrapper. Read `_context/CURRENT-STATE.md`, `_context/WORKFLOW-GOVERNANCE.md`, `_context/INDEX.md`, `.claude/skills/_shared/operating-contract.md`, and `.claude/skills/knowledge-lint/SKILL.md` completely.
...
Run `.claude/skills/knowledge-lint/SKILL.md`.
