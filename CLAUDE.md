...
- **차기 작업 진입점**: `_context/FABLE-LIVE-AUDIT-2026-07-07.md` — KOSPI -8% 실폭락일(2026-07-07) 라이브 v52.21 실브라우저+외부 실측 전수 감사. 발견 대장 C1~C7(워커 405로 AI/번역 전멸·TruthGate 위기 역설·KOSPI 기준일 오프셋·VIX9D 역판정·SW v52.4 고착)·L/F/U/X군 + 근본원인 6뿌리 + 구조 개선 Phase L0~L5. **시작은 L0(워커 계약·번역 헤드라인 폴백·SW) → L3-1+L2-3(=ARCH Phase 0-1 R280 게이트+0-2 KR orphan 통합) → L1(Verdict Gate)** 순. 전 항목 로컬 v52.23 재현 확인 후 착수(라이브 감사 기준). 선행 문서: `FABLE-ARCH-DIAGNOSIS-2026-07-06.md`(정적 진단, Phase 0~4 로드맵 — §5 통합표 참조).
