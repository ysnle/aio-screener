...
- **차기 작업 진입점**: `_context/FABLE-UIUX-DEEP-AUDIT-2026-07-08.md` §5~6 — **Phase V0**(P0 결함: 크래시·표면 단일화·F&G 이중값·kr-technical, 결정 카드 ③ 선결) → **V1**(프록시 계층 구조화 = UX-03/X1 근본) → **V3-1**(뷰포트 매트릭스 CI). 병행: `FABLE-LIVE-AUDIT-2026-07-07.md` L4 잔여/L5(V1이 L5-3 흡수). 선행 문서: `FABLE-ARCH-DIAGNOSIS-2026-07-06.md`(정적 진단, Phase 0~4 로드맵).
