...
- **차기 작업 진입점**: `_context/FABLE-EDU-OVERHAUL-DESIGN-2026-07-09.md` §6 — 22페이지 교육 레이어(개념·원리·시장연결·실전) 대규모 개편. 전수 감사 매트릭스(§1)·컴포넌트 설계(§3)·페이지별 콘텐츠 원고(§4)·게이트 계획(§5)까지 설계 완료(Fable 5, 코드 무변경), **구현은 Sonnet 5 세션이 §6 체크리스트대로**(예정 v52.39, P654/R291/T869). 이전 진입점 `FABLE-UIUX-DEEP-AUDIT-2026-07-08.md` Phase V0~V4는 v52.27~v52.34에서 코드 가능 항목 완료(잔여는 운영자/사람 항목). 선행 문서: `FABLE-ARCH-DIAGNOSIS-2026-07-06.md`(정적 진단, Phase 0~4 로드맵).
