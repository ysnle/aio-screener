...
var _SENT_COMMON = {
  ...
  labels20: ['2/20','2/24','2/26','2/27','3/3','3/5','3/6','3/10','3/12','3/13','3/17','3/19','3/20','3/24','3/26','3/31','4/2','4/3','4/6','4/7','4/8','4/9','4/10','4/13','4/14','4/15','4/16','4/17','4/21','4/22','4/23','4/24','4/25','4/28','4/29','4/30','5/1','5/8','5/15','5/22','5/28','6/4','6/5','6/11','6/16','6/18']  /* v50.76: 6/18 연장 — 6/17 FOMC 매파 충격(VIX 재상승)·KOSPI 9000·달러 강세 반영 */
};
...
function _renderSentimentCanvasFallbackCharts() {
  ...
  var vixData = [19.09,19.55,18.63,19.86,23.57,23.75,29.49,24.93,27.29,27.19,22.37,24.06,25.50,26.95,30.20,34.10,23.87,23.87,24.17,25.78,21.04,31.50,31.10,29.80,18.36,18.36,17.82,17.48,17.95,18.40,19.60,20.10,19.50,18.92,17.83,17.50,16.99,15.80,15.20,14.90,15.74,15.40,19.38,16.00,16.18,18.44]; // v50.76: 6/18 연장 (FOMC 매파 충격 VIX 재상승)
  var hyData = [278,285,282,290,305,312,340,325,335,338,310,328,335,348,362,385,316,316,317,324,301,310,294,308,285,284,281,279,282,286,292,297,294,291,296,294,290,285,280,276,278,275,289,278,272,278]; // v50.76: 6/18 연장 (FOMC 매파 충격→스프레드 소폭 확대)
...
function _initSentVixChart() {
  ...
  var vixData = [19.09, 19.55, 18.63, 19.86, 23.57, 23.75, 29.49, 24.93, 27.29, 27.19, 22.37, 24.06, 25.50, 26.95, 30.20, 34.10, 23.87, 23.87, 24.17, 25.78, 21.04, 31.50, 31.10, 29.80, 18.36, 18.36, 17.82, 17.48, 17.95, 18.40, 19.60, 20.10, 19.50, 18.92, 17.83, 17.50, 16.99, 15.80, 15.20, 14.90, 15.74, 15.40, 19.38, 16.00, 16.18, 18.44]; /* v50.76: 6/18=18.44 — 6/5 셀오프→회복→6/17 FOMC 매파 충격 재상승. 라이브 fetch 우선, 이건 폴백 */
...
function initBreadthPage(forceReinit) {
  ...
  const bpLabels = ['3/6','3/9','3/10','3/11','3/12','3/13',
    ...
    '4/18','4/21','4/22','4/23','4/24','4/25','4/28','4/29','4/30','5/1','5/8','5/15','5/22','5/28','6/4','6/5','6/11','6/16','6/18']; // v50.76: 6/18 연장 (KOSPI 9000·FOMC 매파·S&P 반등 7500)

  const bpSPY   = [640,635,638,633,628,631,635,643,648,655,651,647,650,644,640,636,639,634,629,622,620,623,638,648,655,663,678,692,702,702,710,712,713,710,714,715,717,716,718,719,721,728,740,748,752,758,738,749,752,746]; // v50.76: 6/18 $746 (SPX 7500, FOMC 후 반등)
  const bpQQQ   = [556,550,554,548,544,547,551,558,563,569,565,561,564,558,554,549,552,547,542,534,532,535,551,563,570,578,585,593,595,593,649,652,654,651,655,657,660,659,662,665,671,678,692,705,712,717,687,700,708,702]; // v50.76: 6/18 $702 (NASDAQ 26517)
  ...
  const bpSPX5  = [42, 40, 41, 39, 37, 38, 40, 43, 44, 43, 42, 40, 41, 39, 38, 36, 37, 39, 38, 37.8, 37.5, 39.0, 55, 68, 70, 72, 74, 75, 76, 75, 77, 76, 77, 75, 78, 79, 77, 76, 79, 78, 78, 80, 82, 81, 80, 78, 61, 67, 65, 65];   // $SPXA5R (v50.76: 6/18 65 반등)
  const bpNDX5  = [38, 36, 37, 35, 33, 35, 37, 39, 40, 40, 38, 36, 37, 35, 34, 32, 33, 36, 35, 33.4, 33.2, 35.0, 50, 65, 67, 69, 71, 72, 73, 72, 74, 73, 74, 72, 75, 76, 74, 73, 76, 75, 75, 76, 78, 77, 76, 74, 58, 64, 62, 62];   // MNFD (v50.76: 6/18 62)
  const bpSPX20 = [36, 35, 34, 33, 32, 33, 34, 35, 36, 37, 36, 35, 34, 33, 32, 31, 32, 33, 32, 32.0, 31.8, 32.5, 58, 75, 76, 78, 79, 80, 80, 80, 81, 82, 82, 82, 83, 83, 83, 83, 84, 84, 85, 85, 86, 85, 84, 82, 57, 61, 59, 59];   // $SPXA20R (v50.76: 6/18 59)
  // ── v14: Breadth200 최신값을 전역 변수에 캐싱 (computeTradingScore 참조용) ──
  const bpNDX20 = [28, 27, 26, 25, 24, 25, 26, 27, 28, 28, 27, 26, 25, 24, 23, 22, 23, 24, 23, 23.2, 23.0, 23.8, 55, 72, 73, 75, 76, 77, 78, 78, 79, 80, 80, 80, 81, 81, 81, 81, 82, 82, 83, 83, 84, 83, 82, 80, 55, 59, 57, 57];   // MNTW (v50.76: 6/18 57)
  const bpSPX50 = [38, 37, 36, 35, 34, 34, 35, 36, 37, 38, 37, 36, 35, 34, 33, 32, 32, 33, 32, 31.8, 31.5, 32.2, 38, 46, 48, 50, 51, 52, 53, 54, 55, 57, 58, 59, 61, 62, 63, 65, 67, 69, 71, 72, 74, 75, 74, 72, 52, 56, 54, 54];   // $SPXA50R (v50.76: 6/18 54)
  const bpNDX50 = [34, 33, 32, 31, 30, 30, 31, 32, 33, 33, 32, 31, 30, 29, 28, 28, 29, 29, 28, 27.6, 27.4, 28.2, 40, 49, 51, 52, 53, 54, 55, 55, 56, 58, 59, 60, 62, 63, 64, 66, 68, 70, 72, 73, 75, 76, 75, 73, 53, 57, 55, 55];   // MNFI (v50.76: 6/18 55)
