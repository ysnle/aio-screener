...
var SCREENER_DB = [
  ...
  { sym:'MU', name:'Micron Technology', sector:'Technology', signal:'BUY', memo:'[Susquehanna 05/29] PT$1750(기존$600↑↑) · Q2 DRAM ASP +50~60%QoQ(YoY+421%) · Q2 NAND ASP +75~100%QoQ(YoY+362%) · Dell 공급 제약 ①NAND ②DRAM → 메모리 희소성 구조화 · 메모리 부족 24개월+ 지속 · AVGO 연중반 HBM+CoWoS 주문 압박=공급 매진 · [DA Davidson 04/29] PT$1000 FY30 매출$393B · [Melius 04/29] PT$700 역SaaS테마 G1-G4 위계 · HBM4 CY26 완판 · TrendForce 2026E 메모리TAM $889B→2027E $1.28T+', mcap:477, rsi:42, index:'SP500' },
  ...
  { sym:'000660.KS', name:'SK하이닉스', sector:'Technology', signal:'BUY', memo:'[KB증권 05/29] PT380만원(기존300만원↑) · 2Q 고객 수요 충족률 50%=공급 부족 극심 · 메모리 가격 시장기대 상회 전망 · [JPM OW PT180만원/Citi BUY PT170만원 04/25] 1Q26 OP 37.6조 사상 최대(QoQ+96%/YoY+405%) · DRAM ASP +60%대중반/NAND ASP +70%대중반 · HBM4 고객 일정 준수·향후 3년 수요>공급 · LTA: 고객 요청 급증·3~5년 물량+선불 협의 중 · NAND 321단 연말 50% 전환 · SOCAMM2 양산(Vera 192GB) · 26E Capex 43조(YoY+57%)', mcap:120, rsi:52, index:'KOSPI' },
