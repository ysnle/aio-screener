...
var SCREENER_DB = [
  ...
  { sym:'MU', name:'Micron Technology', sector:'Technology', signal:'BUY', memo:'[Susquehanna 05/29] PT$1750(기존$600↑↑) · Q2 DRAM ASP +50~60%QoQ · Q2 NAND ASP +75~100%QoQ · [JPM 05/29] NVDA용 HBM 2중 체제(SKH 1강에 대항) + ASIC용 HBM 2중 체제(삼성 1강에 대항) = 양쪽 HBM 모두 참여 · 글로벌 메모리 선호주 ③위 · TrendForce DRAM 2026E $619B(+303%YoY)·2027E $903B(+46%) · Dell 공급 제약 ①NAND ②DRAM 실증 · [DA Davidson 04/29] PT$1000 FY30 매출$393B 5년SCA · [Melius 04/29] PT$700 역SaaS G1-G4 · HBM4 CY26 완판 · AVGO 연중반 HBM+CoWoS 주문 압박', mcap:477, rsi:42, index:'SP500' },
  ...
  { sym:'6600.T', name:'Kioxia Holdings', sector:'Technology', signal:'BUY', memo:'[UBS 05/29] 매수 개시 PT 79,000엔. FY3/27 OP 7.11조엔(컨센 6.43조↑)/FY3/28 OP 8.99조엔(컨센 7.47조 대폭 상회). NAND 가격 향후 6분기 QoQ 상승 후 2027Q3 정점. 수평(측면) 스케일링 기술로 웨이퍼비용 억제=비트당 비용 경쟁우위. BICS10(332단)·400단 전환 전 수익성 최고점 예상. AI 추론 = NAND 구조적 수요(사용자 경험 정의 변수). FY3/27~28 업계 최고 NAND 마진 유지 전망. [JPM 05/29] 글로벌 메모리 선호주 ②위. Q2 NAND ASP +75~100%QoQ 직접 수혜=고마진 사이클 향유', mcap:30, rsi:52, index:'TSE' },
  { sym:'8035.T', name:'Tokyo Electron', sector:'Technology', signal:'BUY', memo:'[JPM 05/29] 글로벌 메모리 선호주 ⑤위 — HBM4 고용량화+첨단패키징 장비 수요 직접 수혜. 메모리 TAM 2028E $1.7T 경로에서 WFE(웨이퍼장비) 지출 동반 급증. [기존] 테라팹(머스크) "빛의 속도" 견적 요청 후 TEL +6% 급등. CoWoS/HBM 패키징 장비 수요 구조적 확대. 메모리 사이클 상승 = TEL 가장 직접 수혜하는 일본 반도체 장비주', mcap:55, rsi:55, index:'TSE' },
  ...
  { sym:'005930.KS', name:'삼성전자', sector:'Technology', signal:'BUY', memo:'[GS 04/15 Buy 유지] [05/31 JP모건] MS→삼성 LTA 선지급 $100억+ 확인=공급 희소성 구조화 · 요코하마 신규 반도체 공장 300억엔 투자 예정 · 미국 투자자 선호 SEC>SK하이닉스 — 일반메모리 비중↑=이익 레버리지 + HBM4 따라잡기 · 1Q26 OP 역대 최강 2017-18 사이클 연간평균 상회 = ROE/P/B 구조 전환 · HBM4 고핀속도(11Gbps+) 램프업 문제 미보고 · DRAM/NAND ASP +75-85% QoQ · Q2 NAND ASP +75~100% 전망=삼성 NAND 비중 극수혜 · 수급 타이트 2028H1 · 약세 리스크: 26H2 가격 둔화·중국 공급 위협', mcap:350, rsi:45, index:'KOSPI' },
  { sym:'000660.KS', name:'SK하이닉스', sector:'Technology', signal:'BUY', memo:'[KB증권 05/29] PT380만원(기존300만원↑) · 2Q 충족률 50%=부족 극심·2028까지 공급<수요·에이전틱AI 토큰 7배 증가 · "메모리 마라톤 5km" 본격 레이스 시작 · [JPM 05/29] NVDA용 HBM 1강(점유 독점적 우위) — HBM4 11Gbps+ 기술 격차 유지 · 글로벌 메모리 선호주 ①위 · [JPM OW PT180만원/Citi BUY PT170만원 04/25] 1Q26 OP 37.6조 사상 최대(QoQ+96%/YoY+405%) · DRAM ASP +60%대중반/NAND ASP +70%대중반 · 베라 루빈 메모리 원가 블랙웰 대비 5배 확대 · SOCAMM2 양산(Vera 192GB) · 26E Capex 43조(YoY+57%)', mcap:120, rsi:52, index:'KOSPI' },
