...
var SCREENER_DB = [
  ...
  { sym:'SNDK', name:'SanDisk', sector:'Technology', signal:'BUY', memo:'[JPM 04/29] 1Q26 매출$5.95B(QoQ+97%/YoY+251%) EPS$23.41 GM78.4% 역대최고 · F4Q 가이던스 $7.75-8.25B GM79-81% · 5개 신규SCA(최소RPO $42B+금융보증$11B) · $60억 자사주매입 · [Citi] PT$1300 매수유지 · [Melius] BUY PT$1350(2년) KV캐시 오프로드 G3.5계층 HBF 콜옵션 · 역SaaS 거래 테마 선두 · HBM 대비 동일비용 8-16배 용량 HBF · FY27 EPS $113 경로 · NAND BiCS8 고밀도 · 엔터프라이즈SSD+295%YoY · 데이터센터 믹스 15%→30%+(12개월내)', mcap:102, rsi:52, index:'SP500' },
...
var HOME_WEEKLY_NEWS = [
  { title: '하이퍼스케일러 Q1 어닝 — AWS +28%(15분기 최고·백로그$3,640억), Azure +39%CC(AI ARR $37B +123%YoY), Google Cloud +63%($20B·백로그$4,620억), Bedrock +170% QoQ. CY26 합산 CapEx $7,000억+(BofA CY27 $1조 전망). SNDK GM78.4% 역대최고(F4Q 가이던스 GM79-81%), WDC GM50.5%, STX GM47%(+480bp), SIMO 1Q26 YoY+105%. QCOM +16%: 핸드셋 저점·DC ASIC 12월 하이퍼스케일러 출하.', source: 'JPM/Citi/BofA', date: '2026-04-29', sentiment: 'bull', topic: 'macro' },
  { title: 'SIMO BootDrive 패러다임 + Melius 메모리 커버리지 개시 — SIMO 부트드라이브 $30M→2026E $160M/2027E $375M(BlueField-4 NIC 탑재·ASP 2x+). JPM PT$260(기존$145↑). Melius: SNDK PT$1350·MU PT$700 커버리지 개시 — 역SaaS 거래/메모리 구독화 테마. DA Davidson MU PT$1000(FY30 EPS$139 경로). G1-G4 4계층 메모리 위계 프레임워크.', source: 'JPM/Melius/DA Davidson', date: '2026-04-29', sentiment: 'bull', topic: 'semi' },
  { title: 'UAE OPEC+ 탈퇴(5/1부로) + xAI 모델 증류 법정 확인 — Citi: UAE 생산능력-쿼터 격차 구조적·지정학적 재정렬. 머스크 법정 증언 "부분적으로" 확인·"업계 표준 관행" 주장. 중국 B300 그레이마켓 $55만→~$100만(약 2배)·중국 AI 토큰 글로벌 32%.', source: 'Citi/Bloomberg', date: '2026-05-01', sentiment: 'warn', topic: 'geopolitics' },
];
