...
export const DATA_SOURCE_REGISTRY = Object.freeze({
  ...
  'treasury-curve': entry({
    ...
    origins: [{ id: 'us-treasury-daily-par-curve', authority: 'official-government', sourceKind: 'T1_OFFICIAL', access: 'public-web', url: 'https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?type=daily_treasury_yield_curve', fields: ['2Y', '5Y', '10Y', '20Y', '30Y', 'same-date 10Y-2Y'] }, { id: 'fred-h15-treasury', authority: 'official-government-relay', sourceKind: 'T1_OFFICIAL', access: 'api-key', url: 'https://fred.stlouisfed.org/docs/api/fred/series_observations.html', fields: ['DGS2', 'DGS5', 'DGS10', 'DGS20', 'DGS30', 'T10Y2Y'] }, { id: 'yahoo-treasury-indexes', authority: 'secondary', sourceKind: 'public-information-service', access: 'public-unofficial', url: 'https://query1.finance.yahoo.com/v8/finance/chart/', fields: ['IRX', 'FVX', 'TNX', 'TYX'] }], structuralLimit: null
  }),
  'hy-oas': entry({
    ...
    origins: [
      { id: 'fred-baml-hy-oas', authority: 'official-government-relay', sourceKind: 'T1_OFFICIAL', access: 'api-key', url: 'https://fred.stlouisfed.org/series/BAMLH0A0HYM2', fields: ['BAMLH0A0HYM2'] },
      { id: 'fred-baml-hy-oas-public-csv', authority: 'official-government-relay', sourceKind: 'T1_OFFICIAL', access: 'public-download', url: 'https://fred.stlouisfed.org/graph/fredgraph.csv?id=BAMLH0A0HYM2', fields: ['BAMLH0A0HYM2'] }
    ],
  ...
  'employment-wages': entry({
    ...
    origins: [{ id: 'bls-public-data', authority: 'official-government', sourceKind: 'T1_OFFICIAL', access: 'public-api', url: 'https://www.bls.gov/bls/api_features.htm', fields: ['UNRATE', 'PAYEMS', 'AHE', 'LFPR'] }], structuralLimit: null
  }),
  ...
  'central-bank-policy': entry({
    ...
    origins: [{ id: 'fred-fedfunds', authority: 'official-government-relay', sourceKind: 'T1_OFFICIAL', access: 'api-key', url: 'https://fred.stlouisfed.org/series/FEDFUNDS', fields: ['fedRate'] }, { id: 'federal-reserve-fomc', authority: 'official-central-bank', sourceKind: 'T1_OFFICIAL', access: 'public-web', url: 'https://www.federalreserve.gov/monetarypolicy/fomccalendars.htm', fields: ['FOMC decisions'] }, { id: 'bok-ecb-boj-boe', authority: 'official-central-banks', sourceKind: 'T1_OFFICIAL', access: 'partially-configured', url: 'https://www.bis.org/cbanks.htm', fields: ['BOK', 'ECB', 'BOJ', 'BOE policy rates'] }],
  ...
  'macro-calendar': entry({
    ...
    origins: [{ id: 'fomc-calendar', authority: 'official-central-bank', sourceKind: 'T1_OFFICIAL', access: 'public-web', url: 'https://www.federalreserve.gov/monetarypolicy/fomccalendars.htm', fields: ['FOMC meetings'] }, { id: 'bls-release-calendar', authority: 'official-government', sourceKind: 'T1_OFFICIAL', access: 'public-web', url: 'https://www.bls.gov/schedule/', fields: ['CPI', 'Employment'] }, { id: 'bea-release-schedule', authority: 'official-government', sourceKind: 'T1_OFFICIAL', access: 'public-web', url: 'https://www.bea.gov/news/schedule', fields: ['PCE', 'GDP'] }],
  ...
  'kr-macro-vkospi-supply': entry({
    ...
    origins: [{ id: 'bok-ecos', authority: 'official-central-bank', sourceKind: 'T1_OFFICIAL', access: 'api-key-or-public', url: 'https://ecos.bok.or.kr/api/', fields: ['Korean macro', 'rates', 'FX'] }, { id: 'kosis', authority: 'official-government', sourceKind: 'T1_OFFICIAL', access: 'api-key-or-public', url: 'https://kosis.kr/openapi/', fields: ['Korean statistics'] }, { id: 'krx-koscom', authority: 'official-exchange', sourceKind: 'T1_OFFICIAL', access: 'operator-rights-required', url: 'https://data.krx.co.kr/', fields: ['VKOSPI', 'investor flows', 'official breadth'] }],
