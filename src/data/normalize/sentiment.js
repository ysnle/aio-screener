const SENTIMENT_FIELDS = Object.freeze([
  { metric: 'fearGreed', unit: 'score', sourceKind: 'legacy-runtime', observedAt: 'now', maxAgeMs: 120_000 },
  ...
  { metric: 'aaiiBear', unit: 'percent', sourceKind: 'snapshot', observedAt: 'now', maxAgeMs: null },
  { metric: 'aaiiBull', unit: 'percent', sourceKind: 'snapshot', observedAt: 'now', maxAgeMs: null }
]);
