...
const rows = {
  ...
  "power-cooling->power-electricity-system": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "전력 제약 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
    "sourceStatus": "EVIDENCE_REGISTRY_PENDING"
  },
  "power-electricity-system->power-generation-market": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "발전 믹스 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "power-generation-market->grid-transmission-distribution": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "계통 접속 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "grid-transmission-distribution->energy-storage": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "유연성 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "energy-storage->data-center-power-demand": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "수요 안정화 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "data-center-power-demand->industrial-energy-efficiency": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "효율·냉각 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "industrial-energy-efficiency->critical-minerals": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "소재 수요 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "industry-value-chain->robotics-automation": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "인접 산업 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "robotics-automation->defense-space": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "고신뢰 응용 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "defense-space->biotech-healthcare": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "센서·검증 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "biotech-healthcare->finance-software-consumer": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "상용화 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "finance-software-consumer->us-korea-market": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "가치 포착 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "us-korea-market->krw-dollar-foreign-flow": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "환율·자금 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "krw-dollar-foreign-flow->korea-semiconductor-policy": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "정책 전달 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "korea-semiconductor-policy->tax-accounting-cashflow": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "투자 회수 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "critical-minerals->industry-value-chain": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "공급 병목 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
  ...
  "company-stock-valuation->tax-accounting-cashflow": {
    ...
    "polarity": "NEUTRAL",
    "conditions": [
      "현금흐름 검증 주제를 함께 탐색하기 위한 분류 연결이며 인과관계를 뜻하지 않음"
    ],
    "reviewStatus": "STRUCTURAL_NAVIGATION_ONLY",
    "sourceIds": [],
    "reviewedAt": "2026-08-11",
